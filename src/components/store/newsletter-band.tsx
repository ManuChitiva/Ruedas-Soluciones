  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24 xl:px-10 2xl:px-12">
        <div className="store-card-static relative overflow-hidden rounded-3xl border border-[var(--store-border)] bg-[var(--store-muted)] px-6 py-12 sm:px-10 sm:py-16 lg:px-16">
          <div
            aria-hidden
            className="pointer-events-none absolute -right-16 -top-20 h-64 w-64 rounded-full bg-[var(--store-primary)]/12 blur-3xl"
          />
          <div className="relative mx-auto max-w-2xl text-center">
            ...
            <p className="mx-auto mt-3 max-w-xl text-[15px] leading-relaxed text-[var(--store-text-soft)] sm:text-[16px]">
              {subline}
            </p>
            ...
            >
              <label className="flex min-w-0 flex-1 items-center gap-3 rounded-full border border-[var(--store-border)] bg-[var(--store-surface)] px-4 shadow-[var(--store-shadow-soft)] transition focus-within:border-[var(--store-primary)] focus-within:ring-2 focus-within:ring-[var(--store-ring-focus)]">
